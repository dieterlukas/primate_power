...
for(variant in 1:2){
  ...
  if(variant==1){combined<-original[original$lemur==0,]}
  if(variant==2){combined<-original[original$lemur==1,]}
...
for (j in 1:length(alldiscretepredictors)){
  ...
  write.csv(combinedresults,file="intersexualdominance_combinedresults_nestedbylemur_Nov23.csv")
